...
public class InputManager : MonoBehaviour
{
    ...
    void OnRightClick()
    {
        ...
        if (hit.collider != null && hit.collider.gameObject.GetComponent<Enemy>() != null)
        {
            ...
            SelectionManager.Instance.currentlySelected.GetComponent<Character>().SetDestination(destination); // feed distination to character.cs so that character can use it for movement and range calculations 
